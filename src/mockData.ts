...
export const initialUsers: User[] = [
  {
    ...
    empId: 'EMP-1001',
    name: 'Brijesh Verma',
    email: 'brijesh.verma@emizainc.com',
    password: 'Admin@123',
  ...
  },
  {
    ...
    assignedClientIds: ['cli-bellavita', 'cli-nykaa', 'cli-boat', 'cli-mama', 'cli-sugar'],
    status: 'Active',
    authProvider: 'local',
    lastLoginAt: '2026-08-25T07:15:00Z',
  ...
  },
  {
    ...
    status: 'Active',
    authProvider: 'local',
    lastLoginAt: '2026-08-25T06:45:00Z',
  ...
  },
  {
    ...
    role: 'RTO Operator',
    department: 'RTO & Returns',
    companyId: 'comp-1',
    assignedWarehouseIds: ['wh-main'],
    assignedClientIds: ['cli-bellavita', 'cli-nykaa'],
    status: 'Active',
    authProvider: 'local',
    lastLoginAt: '2026-08-25T08:12:00Z',
  ...
  },
  {
    ...
    empId: 'EMP-1006',
    name: 'Sandeep Yadav',
    email: 'sandeep.y@emiza.com',
    password: 'Grn@123',
    phone: '+91 98550 44332',
    role: 'GRN Operator',
    department: 'GRN & Inward',
    companyId: 'comp-1',
    assignedWarehouseIds: ['wh-main'],
    assignedClientIds: ['cli-boat', 'cli-sugar', 'cli-mama'],
    status: 'Active',
    authProvider: 'local',
    lastLoginAt: '2026-08-25T07:50:00Z',
  ...
  },
  {
    ...
    empId: 'EMP-1007',
    name: 'Neha Sharma',
    email: 'neha.s@emiza.com',
    password: 'Audit@123',
    phone: '+91 98660 22110',
    role: 'Auditor',
    ...
    status: 'Active',
    authProvider: 'local',
    lastLoginAt: '2026-08-25T08:05:00Z',
