...
export const LoginPage: React.FC = () => {
  ...
  const handleQuickLogin = async (demoEmail: string, demoPass: string = 'Admin@123') => {
    setEmail(demoEmail);
      ...
      <div className="w-full max-w-[1000px] min-h-[580px] bg-card rounded-[28px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-theme overflow-hidden flex flex-col md:flex-row theme-transition">
        ...
        <div className="md:w-5/12 bg-gradient-to-br from-[#7C3AED] via-[#8B5CF6] to-[#EC4899] text-white p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <span className="text-sm font-bold tracking-wider uppercase text-purple-100 font-mono">WOP-Emiza</span>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mt-6 pt-5 border-t border-slate-200/80 dark:border-slate-800">
              <div className="flex items-center justify-between mb-2.5">
                ...
                <span className="text-[10px] text-slate-400">Individual Credentials</span>
              </div>

              <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5">
                <button
                  type="button"
                  onClick={() => handleQuickLogin('verma.brijesh0501@gmail.com', 'Admin@123')}
                  disabled={isSubmitting}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('vikram.m@emiza.com', 'Manager@123')}
                  disabled={isSubmitting}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('pooja.d@emiza.com', 'Super@123')}
                  disabled={isSubmitting}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('amit.p@emiza.com', 'Rto@123')}
                  disabled={isSubmitting}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('neha.s@emiza.com', 'Audit@123')}
                  disabled={isSubmitting}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('rajesh.security@emiza.com', 'Security@123')}
                  disabled={isSubmitting}
            ...
            <div className="mt-5 text-center">
              <p className="text-[11px] text-slate-400">
                Authorized Personnel Only • WOP-Emiza Supply Chain Operations
              </p>
            </div>
          </div>
        </div>
